package com.soaringloong.jfrm.framework.mybatis.core.query;
...
public class QueryWrapperX<T> extends QueryWrapper<T> {
	...
	// @java.io.Serial
	private static final long serialVersionUID = -238257294049525552L;
	...
	public QueryWrapperX<T> limitN(int n) {
		...
		switch (SqlConstants.DB_TYPE) {
			...
			case SQL_SERVER:
			case SQL_SERVER2005:
				super.select("TOP " + n + " *"); // 由于 SQL Server 是通过 SELECT TOP 1
													// 实现限制一条，所以只好使用 * 查询剩余字段
				break;
			default:
				super.last("LIMIT " + n);
		}
