...
public class JFrmJacksonAutoConfiguration {
	 ...
	 * spring.jackson.date-format=yyyy-MM-dd HH:mm:ss (这种配置仅针对java.util.Date生效) 原因:
	...
	public MappingJackson2HttpMessageConverter getMappingJackson2HttpMessageConverter(
		...
		mappingJackson2HttpMessageConverter
			.setObjectMapper(this.objectMapper != null ? this.objectMapper : CollUtil.getFirst(objectMappers));
