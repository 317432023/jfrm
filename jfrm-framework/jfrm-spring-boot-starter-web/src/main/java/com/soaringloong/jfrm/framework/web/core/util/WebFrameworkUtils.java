package com.soaringloong.jfrm.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import com.comm.pojo.R;
import com.comm.pojo.enums.TerminalEnum;
import com.comm.pojo.enums.UserTypeEnum;
...
public class WebFrameworkUtils {
	 ...
	 * 终端的 Header
	 *
	 * @see com.comm.pojo.enums.TerminalEnum
	 */
	...
	public static Integer getLoginUserType(HttpServletRequest request) {
		...
		if (request.getServletPath().startsWith(properties.getMemberApi().getPrefix())) {
