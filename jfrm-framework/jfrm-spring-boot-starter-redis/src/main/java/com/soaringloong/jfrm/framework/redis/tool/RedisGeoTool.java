...
public class RedisGeoTool {
	...
	/**
	 * 添加经纬度信息 redis 命令: geoadd <key> <lat> <lng> <member>
	 */
	...
	/**
	 * 查找指定key的经纬度信息 redis命令：geopos <key> <member>
	 */
	...
	/**
	 * 返回两个位置的距离 redis 命令：geodist <key> <member1> <member2>
	 */
	...
	/**
	 * 给定经纬度，返回半径不超过指定距离的元素 redis 命令：georadius <key> <lat> <lng> <number> <metrics>
	...
	/**
	 * 给定经纬度，返回半径不超过指定距离的元素 redis 命令：georadiusbymember <key> <member> <number> <metrics>
	 * WITHDIST WITHCOORD ASC
	 */
	...
	/**
	 * geohash redis 命令：geohash <key> <member>
	 */
