package com.soaringloong.jfrm.framework.test.util;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ReflectUtil;
import com.comm.pojo.ErrorCode;
...
public class AssertUtils {
	...
	public static void assertPojoEquals(Object expected, Object actual, String... ignoreFields) {
		...
		Arrays.stream(expectedFields).forEach(expectedField -> {
			...
			// 比对
			Assertions.assertEquals(ReflectUtil.getFieldValue(expected, expectedField),
	 ...
	 */
	public static void assertSystemException(Executable executable, ErrorCode errorCode, Object... messageParams) {
		assertSystemException(executable, errorCode.code, errorCode.msg, messageParams);
	}
	 ...
	 * @param messageParams 消息参数
	 */
	public static void assertSystemException(Executable executable, int code, String msg, Object... messageParams) {
		// 调用方法
		SystemException serviceException = assertThrows(SystemException.class, executable);
		// 校验错误码
		Assertions.assertEquals(code, serviceException.getCode(), "错误码不匹配");

		String message = SystemExceptionUtil.doFormat(code, msg, messageParams);
