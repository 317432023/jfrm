...
import com.soaringloong.jfrm.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
import com.soaringloong.jfrm.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
...
public interface OAuth2AccessTokenMapper extends BaseMapperX<OAuth2AccessTokenDO> {
    ...
    //TODO @TenantIgnore // 获取 token 的时候，需要忽略租户编号。原因是：一些场景下，可能不会传递 tenant-id 请求头，例如说文件上传、积木报表等等
